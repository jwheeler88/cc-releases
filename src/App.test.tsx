...
const mockReleases: Release[] = [
  ...
  },
  {
    ...
    date: '2025-01-10',
    entries: [
      { content: 'Performance improvements for Z', category: 'performance' as const },
    ],
  },
];

// Helper function to mock the useChangelog hook with specific states
const mockHook = (state: Partial<ReturnType<typeof useChangelogModule.useChangelog>>) => {
...
describe('App', () => {
  ...
  describe('Success State', () => {
    ...
    it('renders all releases in the list', () => {
      ...
      const versionHeadings = Array.from(headings).filter(h =>
        h.textContent?.includes('1.0.53') || h.textContent?.includes('1.0.52')
      );
    ...
    it('renders all release entries with correct content', () => {
      ...
      expect(screen.getByText(/Performance improvements for Z/i)).toBeInTheDocument();
    });
